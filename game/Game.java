...
public static void main(String[] args) throws IOException {
  ...
  road = ImageIO.read(Game.class.getResourceAsStream("road.jpg"));
  rainb = ImageIO.read(Game.class.getResourceAsStream("rainb.png"));
...
game_window.add(game_field); //Issers
...
g.drawImage(rainb,(int) drop_left, (int) drop_top, null);
if (drop_top > game_window.getHeight()) g.drawImage(car, 210, 150, null);//Issers
